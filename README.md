...
| 09 | [Actions — Making Actions with MCP and Stripe](./cookbooks/09-actions-with-mcp-stripe/) | `nebius-agentkit` `mcp` `stripe` `langchain` `fastapi` `structlog` `prometheus` `docker` | advanced | 15 min |
